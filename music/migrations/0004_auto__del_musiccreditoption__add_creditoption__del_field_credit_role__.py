...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Credit.role'
        db.add_column('music_credit', 'role',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Credit.credit_option'
    ...
    models = {
        ...
        'music.credit': {
            ...
            'credit_option': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['music.CreditOption']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

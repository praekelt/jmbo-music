...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MusicCreditOption.role_type'
        db.add_column('music_musiccreditoption', 'role_type',
                      self.gf('django.db.models.fields.CharField')(default='artist', max_length=16),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MusicCreditOption.role_type'
    ...
    models = {
        ...
        'music.musiccreditoption': {
            ...
            'role_type': ('django.db.models.fields.CharField', [], {'max_length': '16'})
        },
        'music.track': {
